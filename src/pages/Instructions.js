        ...
        <div className="instructions-wrap">
            ...
            <div className="instructions-container">
                ...
                <div className="instructions-content">
                    <div className="instructions-tab-content" id="tab1">
                    ...
                    <div className="instructions-tab-content" id="tab2">
                    ...
                    <div className="instructions-tab-content" id="tab3">
                    ...
                    <div className="instructions-tab-content" id="tab4">
